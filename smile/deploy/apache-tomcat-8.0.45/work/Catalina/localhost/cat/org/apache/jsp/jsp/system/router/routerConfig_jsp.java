 ...
 * Generated at: 2019-04-16 11:25:31 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t$(\"#routerRebuild\").on('click', function(e) {\n");
      out.write("\t\t\te.preventDefault();\n");
      out.write("\t\t\tvar anchor = this;\n");
      out.write("\t\t\tvar dialog = $( \"#rebuild-router-message\" ).removeClass('hide').dialog({\n");
      ...
      out.write("\t\t\t\t\t\tclick: function() {\n");
      out.write("\t\t\t\t\t\t\t$( this ).dialog( \"close\" ); \n");
      out.write("\t\t\t\t\t\t\twindow.open(anchor.href);\n");
      out.write("\t\t\t\t\t\t} \n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t]\n");
      out.write("\t\t\t});\n");
  ...
  private boolean _jspx_meth_res_005fuseJs_005f1(javax.servlet.jsp.tagext.JspTag _jspx_parent, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsp/system/router/routerConfig.jsp(12,1) name = value type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /jsp/system/router/routerConfig.jsp(12,1) name = target type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("\t\t\t\t\t\t\ttype=\"submit\" name=\"submit\" value=\"提交\" /> &nbsp; &nbsp;&nbsp;&nbsp;\n");
      out.write("\t\t\t\t\t\t\t<a href=\"/cat/s/router?op=build\" class='btn btn-primary' id=\"routerRebuild\" target=\"_blank\">重算路由</a></td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t</table>\n");
      out.write("\t\t\t</form>\n");
