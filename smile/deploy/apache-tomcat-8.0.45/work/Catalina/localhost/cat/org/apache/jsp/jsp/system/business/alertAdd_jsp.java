 ...
 * Generated at: 2019-04-16 11:15:57 UTC
...
return;
  ...
  private boolean _jspx_meth_res_005fuseJs_005f0(javax.servlet.jsp.tagext.JspTag _jspx_parent, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsp/system/business/alertAdd.jsp(12,1) name = value type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /jsp/system/business/alertAdd.jsp(12,1) name = target type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_res_005fuseJs_005f1(javax.servlet.jsp.tagext.JspTag _jspx_parent, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsp/system/business/alertAdd.jsp(13,1) name = value type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /jsp/system/business/alertAdd.jsp(13,1) name = target type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_res_005fuseJs_005f2(javax.servlet.jsp.tagext.JspTag _jspx_parent, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsp/system/business/alertAdd.jsp(14,1) name = value type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /jsp/system/business/alertAdd.jsp(14,1) name = target type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_res_005fuseCss_005f0(javax.servlet.jsp.tagext.JspTag _jspx_parent, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsp/system/business/alertAdd.jsp(15,1) name = value type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /jsp/system/business/alertAdd.jsp(15,1) name = target type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_res_005fuseJs_005f3(javax.servlet.jsp.tagext.JspTag _jspx_parent, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsp/system/business/alertAdd.jsp(16,1) name = value type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /jsp/system/business/alertAdd.jsp(16,1) name = target type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("\t\t\t\t\t<h4 class=\"btn btn-success btn-xs\" >\n");
      out.write("\t\t\t\t\t\t匹配对象<i class=\"icon-plus icon-white\"></i>\n");
      out.write("\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t<div id=\"metricItem\" class=\"metric config\">\n");
      out.write("\t\t\t\t\t\t监控类型： <label class=\"checkbox inline\"> <input name=\"metricType\" value=\"COUNT\"\n");
      out.write("\t\t\t\t\t\t\tid=\"COUNT\" type=\"radio\">count\n");
      out.write("\t\t\t\t\t\t</label> <label class=\"checkbox inline\"> <input name=\"metricType\" value=\"AVG\"\n");
      out.write("\t\t\t\t\t\t\tid=\"AVG\" type=\"radio\">avg\n");
      out.write("\t\t\t\t\t\t</label> <label class=\"checkbox inline\"> <input name=\"metricType\" value=\"SUM\"\n");
      out.write("\t\t\t\t\t\t\tid=\"SUM\" type=\"radio\">sum\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payload.attributes}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("';\n");
      out.write("\t\t\t\n");
      out.write("\t\t\tif (attributes != null && attributes != '') {\n");
      out.write("\t\t\t\tdocument.getElementById(attributes).checked = true;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t\n");
      ...
      out.write("';\n");
      out.write("\t\t\t\tvar key = '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${payload.key}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("';\n");
      out.write("\t\t\t\tvar metrics = $('input:radio[name=\"metricType\"]:checked').val(); \n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\tvar configStr = generateConfigsJsonString();\n");
      out.write("\t\t\t    window.location.href = \"?op=alertRuleAddSubmit&content=\" + encodeURIComponent(configStr) + \"&key=\" + encodeURIComponent(key) +\"&attributes=\" + encodeURIComponent(metrics) + \"&domain=\" + encodeURIComponent(domain);\n");
      out.write("\t\t\t});\n");
      out.write("\t\t});\n");
      out.write("\t</script>\n");
      return false;
